...
# De C#-kant staat niet op elke machine. Ontbreekt hij, dan slaat het script
# dat deel over in plaats van te struikelen.
if not os.path.isdir(os.path.dirname(OUT)):
    print('overgeslagen (geen KlaverjasWin op deze machine): %s' % OUT)
    OUT = os.devnull
