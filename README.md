...
called *Guillermie* in the source. The cards were drawn on millimetre paper with coloured
pencils in the sun; the first version of the program followed at home in September 1990.
Ronald and I, Ed, made the programs independently. Ronald used the brute-force method. Calculate every possible trick and play the one with the highest score. My method used the tactics as I play the game. You can see the tactics rules in the statistics.

After finishing the game both programs were combined in one program so they could play together. Mistakes in the rules were identified and corrected. In the end after 50.000 games played in memory the brute-force method won 51% of the games because it counted the melds too when deciding what trump to to play at the start of the game. It reaches the 1500 points just a little bit earlier, and wins.
The windows version can play the two programs together and you can select between Ed and Ronald game to play against.
